...
export class Contract {
    ...
    this.circuits = {
      createNewCase: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('createNewCase',
      ...
      addDiscoveryStepToCase: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('addDiscoveryStepToCase',
                                     'argument 1 (as invoked from Typescript)',
      ...
      markDiscoveryStepAsCompleted: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('markDiscoveryStepAsCompleted',
                                     'argument 1 (as invoked from Typescript)',
      ...
      checkCaseComplianceStatus: (...args_1) => {
        ...
        const caseUniqueIdentifier_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkCaseComplianceStatus',
                                     'argument 1 (as invoked from Typescript)',
                                 ...
                                 jurisdictionCode_0)
  {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0 && result_0 <= __compactRuntime.MAX_FIELD)) {
      __compactRuntime.typeError('computeUniqueCaseIdentifier',
                                 'return value',
                           ...
                           jurisdictionRuleReference_0)
  {
    ...
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0 && result_0 <= __compactRuntime.MAX_FIELD)) {
      __compactRuntime.typeError('computeUniqueStepHash',
                                 'return value',
  ...
  {
    const callerPublicKey_0 = this._ownPublicKey_0(context, partialProofData);
    const storedOwnerKey_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
                                                                                        { idx: { cached: false,
  ...
  {
    const currentCaseStatus_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                          partialProofData,
                                                                                          [
                                                                                           { dup: { n: 0 } },
                                                                                           { idx: { cached: false,
