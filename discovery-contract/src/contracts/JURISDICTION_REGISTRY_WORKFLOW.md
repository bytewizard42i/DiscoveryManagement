...
> **Type:** Shared singleton (ONE deployment for the entire DiscoveryManagement platform)  
...
```
WHO:    DiscoveryManagement platform administrator (John or designated admin)
...
```
WHO:    Any DiscoveryManagement user (e.g., attorney Sarah)
