...
This is the **backbone** of AutoDiscovery. It manages the lifecycle of legal cases:
...
WHEN:   When a new case is filed or when they adopt AutoDiscovery for an existing case
