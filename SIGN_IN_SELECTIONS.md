...
**Repository role:** The discovery application can reference shared choices while preserving its existing authentication, role gates and case-access controls.
