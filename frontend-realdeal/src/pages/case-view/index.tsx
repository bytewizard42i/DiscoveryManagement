...
export function CaseView() {
  ...
  const handleExportReport = async () => {
    ...
    const reportHtml = `
      ...
      <h1>DiscoveryManagement — Compliance Report</h1>
      ...
      <div class="footer">
        <p>This report was generated by DiscoveryManagement Legal Intelligence. Compliance records can be independently verified against the Midnight blockchain.</p>
        <p>DiscoveryManagement — Privacy-Preserving Discovery Automation</p>
      </div>
      </body></html>`;
